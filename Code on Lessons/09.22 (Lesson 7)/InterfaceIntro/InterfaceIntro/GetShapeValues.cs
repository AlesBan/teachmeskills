...
namespace InterfaceIntro
{
    public class GetShapeValues
    {
        ...
        public static IPrintTable GetNewShape(string className, PrinterConsole printer)
        {
        ...
        public static (int, int) GetCenterOrStartPosition(PrinterConsole printer)
        {
            int x = 0, y = 0;
            while (x <= 0)
            {
        ...
        public static char GetSymble(PrinterConsole printer)
        {
        ...
        public static int GetPositiveIntNum(PrinterConsole printer)
        {
            int num = 0;
            while (num <= 0)
            {
