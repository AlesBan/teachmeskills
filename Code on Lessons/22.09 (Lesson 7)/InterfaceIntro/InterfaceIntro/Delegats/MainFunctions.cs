...
namespace InterfaceIntro.Delegats
{
    ...
    {
        public readonly Action<List<IPrintTable>, Printer> OutPutFunc = (printTables, printer) => OutPutFunction(printTables, printer);
        ...
        public static void OutPutFunction(List<IPrintTable> printTables, Printer printer)
        {
            printer.Clear();
